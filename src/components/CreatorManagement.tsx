              ...
              <TabsContent value="progress" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Track creator through the 5-phase pipeline</CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      {phases.map((phase, index) => (
                        <div
                          ...
                          className={`p-4 border rounded-lg ${
                            selectedCreator.phaseNumber === phase.value
                            ...
                            <div>
                              ...
                              {selectedCreator.phaseNumber === phase.value && (
                                <p className="text-sm text-gray-600 mt-1">
                                  Day {selectedCreator.daysInPhase} • Next: {selectedCreator.nextTask}
                                </p>
                              )}
                            </div>
                            <div className="flex items-center space-x-2">
                              ...
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={() => handlePhaseChange(selectedCreator.id, phase.value)}
                                disabled={selectedCreator.phaseNumber === phase.value}
                              >
                                Move Here
                              </Button>
                            </div>
          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => setIsAddingCreator(false)}>
                  <X className="w-4 h-4" />
                </Button>
              </div>
            </CardHeader>
